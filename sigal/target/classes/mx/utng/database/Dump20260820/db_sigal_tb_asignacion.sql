...
CREATE TABLE `tb_asignacion` (
  ...
  `TipoUsuario` enum('Profesor','Administrativo','Alumno','Otro') COLLATE utf8mb4_general_ci NOT NULL,
...
-- Dump completed on 2026-08-20 16:14:03
