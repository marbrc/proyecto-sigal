...
CREATE TABLE `tb_espacio` (
  ...
  `ClaveEspacio` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `NombreEspacio` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `TipoEspacio` enum('Aula común','Lab. de cómputo','Especializado','Sala múltiple') COLLATE utf8mb4_general_ci NOT NULL,
  `CapacidadMaxima` int NOT NULL,
  `Estado` enum('Disponible','En mantenimiento','Fuera de servicio') COLLATE utf8mb4_general_ci NOT NULL,
