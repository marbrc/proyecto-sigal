...
public class EmailUtil {
    ...
    public static void enviarCodigoRecuperacion(String correoDestino, String nombreUsuario, String codigo)
        ...
        mensaje.setSubject("SIGAL · Código de verificación");
        mensaje.setContent(construirHtml(nombreUsuario, codigo), "text/html; charset=UTF-8");
 
        Transport.send(mensaje);
    }
 
    private static String construirHtml(String nombreUsuario, String codigo) {
        ...
        return "<div style=\"font-family:'Segoe UI',Arial,sans-serif;background:#050814;padding:40px 0;\">"
             ...
             + "    <p style=\"color:#c7cfe8;font-size:14px;\">Recibimos una solicitud para restablecer tu contraseña. Usa el siguiente código para continuar:</p>"
             ...
             + "    </div>"
             + "    <p style=\"color:#93a0c4;font-size:12.5px;\">Este código vence en 10 minutos. Si tú no solicitaste este cambio, ignora este mensaje.</p>"
